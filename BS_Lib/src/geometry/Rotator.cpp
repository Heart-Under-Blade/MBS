...
void LocalRotator::SetRotationMatrix(const Angle3d &angle)
{
...
void GlobalRotator::SetRotationMatrix(const Angle3d &angle)
{
...
void Rotator::SetRotationMatrix(const Angle3d &angle)
{

}

void Rotator::RotatePoint(const Point3f &point, Point3f &result) const
{
